...
import javabasic_02.day11.inheritance.ABC.inheritanceExABC02.F;
...
// JSON에서 속성 순서는 중요하지 않다. 추가한 순서대로 작성하지 않아도 상관없습니다.
// 그리고 줄바꿈 처리도 되지않습니다. 네트워크의 전송량을 줄여주어 오히려 이 점이 장점이 되었다.
// .json 파일을 파싱하는 방법을 실습하겠습니다.
public class ParseJsonEx {
    public static void main(String[] args) {
        // 파일로부터 JSON 읽어오기
        try (BufferedReader bufferedReader = new BufferedReader(new FileReader("EHS.json", Charset.forName("UTF-8")))) {

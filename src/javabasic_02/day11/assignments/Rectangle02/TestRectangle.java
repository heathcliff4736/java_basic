    ...
    public static void main(String s[]) {
        ...
        if (rec1.area() > rec2.area()) {
            System.out.println(rec1.getColor() + " 직사각형의 넓이는 " + rec1.area() + ", "
                    + rec2.getColor() + " 직사각형의 넓이는 " + rec2.area() + "로 " + rec1.getColor() + " 직사각형이 더 넓습니다.");

        } else if (rec1.area() == rec2.area()) {
            System.out.println("두 직사각형의 넓이가 같습니다.");
        } else {
            System.out.println(rec2.getColor() + " 직사각형의 넓이는 " + rec2.area() + ", "
                    + rec1.getColor() + " 직사각형의 넓이는 " + rec1.area() + "로 " + rec1.getColor() + " 직사각형이 더 넓습니다.");
        }


        // TODO 2) 두 직사각형의 둘레를 비교하십시오.
        if (rec1.perimeter() > rec2.perimeter()) {
            System.out.println(rec1.getColor() + " 직사각형의 넓이는 " + rec1.perimeter() + ", "
                    + rec2.getColor() + " 직사각형의 넓이는 " + rec2.perimeter() + "로 " + rec1.getColor() + " 직사각형이 더 넓습니다.");

        } else if (rec1.perimeter() == rec2.perimeter()) {
            System.out.println("두 직사각형의 둘레가 같습니다.");
        } else {
            System.out.println(rec2.getColor() + " 직사각형의 넓이는 " + rec2.perimeter() + ", "
                    + rec1.getColor() + " 직사각형의 넓이는 " + rec1.perimeter() + "로 " + rec1.getColor() + " 직사각형이 더 넓습니다.");
        }
    }
}
